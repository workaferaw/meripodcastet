        ...
        <TransitionWrapper animation="fade-in" delay={600}>
          <div className="mt-16 flex flex-wrap justify-center items-center gap-8">
            ...
            <div className="flex items-center gap-8">
              <div className="text-muted-foreground hover:text-foreground transition-colors font-medium text-sm flex items-center group">
                <svg className="w-5 h-5 mr-2 transition-transform duration-300 group-hover:scale-110 group-hover:text-primary" viewBox="0 0 24 24" fill="currentColor">
